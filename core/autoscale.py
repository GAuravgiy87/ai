...
Usage:
    python core/autoscale.py  # Auto-scaling enabled by default
    python core/autoscale.py --min-workers 2 --max-workers 16 --cpu-threshold 70
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python core/autoscale.py --min-workers 2 --max-workers 16 --cpu-threshold 65"
    )
    parser.add_argument("--app", default="run.py", help="FastAPI app entry point (default: run.py)")
